...
#define	LCD_LED PDout(9) //LCD背光    		 PC10 
...
//#define	LCD_CS_SET  GPIOA->BSRRL=1<<4    //片选端口  	PC9
//#define	LCD_RS_SET	GPIOA->BSRRL=1<<5    //数据/命令   	PC8	   
//#define	LCD_WR_SET	GPIOA->BSRRL=1<<6    //写数据		PC7
//#define	LCD_RD_SET	GPIOA->BSRRL=1<<7    //读数据		PC6
//#define	LCD_RST_SET	GPIOA->BSRRL=1<<1    //复位			PC5
//								    
//#define	LCD_CS_CLR  GPIOA->BSRRH=1<<4     //片选端口  	PC9
//#define	LCD_RS_CLR	GPIOA->BSRRH=1<<5     //数据/命令  	PC8	   
//#define	LCD_WR_CLR	GPIOA->BSRRH=1<<6     //写数据		PC7
//#define	LCD_RD_CLR	GPIOA->BSRRH=1<<7     //读数据		PC6
//#define	LCD_RST_CLR	GPIOA->BSRRH=1<<1    //复位			PC5								    
